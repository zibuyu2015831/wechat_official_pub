...
from module.aligo.request import CopyFileRequest, BatchCopyFilesRequest
from module.aligo.response import CopyFileResponse, BatchSubResponse
...
class Copy(Core):
    ...
    def copy_file(self, body: CopyFileRequest) -> CopyFileResponse:
        ...
        用法示例：
        >>> from module.aligo import Aligo, CopyFileRequest
        >>> ali = Aligo()
    ...
    def batch_copy_files(self, body: BatchCopyFilesRequest) -> List[BatchSubResponse[CopyFileResponse]]:
        ...
        用法示例：
        >>> from module.aligo import Aligo, BatchCopyFilesRequest
        >>> ali = Aligo()
