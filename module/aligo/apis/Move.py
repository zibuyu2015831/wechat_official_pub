...
from module.aligo.request import MoveFileRequest, BatchMoveFilesRequest
from module.aligo.response import MoveFileResponse, BatchSubResponse
...
class Move(Core):
    ...
    def move_file(self, file_id: str,
        ...
        用法示例：
        >>> from module.aligo import Aligo, MoveFileRequest
        >>> ali = Aligo()
    ...
    def batch_move_files(self,
        ...
        用法示例：
        >>> from module.aligo import Aligo, BatchMoveFilesRequest
        >>> ali = Aligo()
