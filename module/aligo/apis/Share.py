...
from module.aligo.request import *
from module.aligo.response import *
from module.aligo.types import BaseShareFile, ShareLinkSchema, DriveFile
from module.aligo.types.Enum import OrderDirection, SearchFileOrderBy, GetShareLinkListOrderBy
...
class Share(Core):
    ...
    def get_share_file_list(
        ...
        用法示例：
        >>> from module.aligo import Aligo, GetShareFileListRequest
        >>> ali = Aligo()
        >>> share = ali.share_file('<file_id>')
        >>> # noinspection PyShadowingNames
        >>> share_token = ali.get_share_token(share.share_id)
    ...
    def get_share_file(self, body: GetShareFileRequest, share_token: GetShareTokenResponse) -> BaseShareFile:
        ...
        用法示例：
        >>> from module.aligo import Aligo, GetShareFileRequest
        >>> ali = Aligo()
        >>> share = ali.share_file('<file_id>')
        >>> # noinspection PyShadowingNames
        >>> share_token = ali.get_share_token(share.share_id)
    ...
    def get_share_link_download_url(
        ...
        用法示例：
        >>> from module.aligo import Aligo, GetShareLinkDownloadUrlRequest
        >>> ali = Aligo()
        >>> share = ali.share_file('<file_id>')
        >>> # noinspection PyShadowingNames
        >>> share_token = ali.get_share_token(share.share_id)
    ...
    def share_file_saveto_drive(
        ...
        用法示例：
        >>> from module.aligo import Aligo, ShareFileSaveToDriveRequest
        >>> ali = Aligo()
        >>> share = ali.share_file('<file_id>')
        >>> # noinspection PyShadowingNames
        >>> share_token = ali.get_share_token(share.share_id)
    ...
    def batch_share_file_saveto_drive(
        ...
        用法示例：
        >>> from module.aligo import Aligo, BatchShareFileSaveToDriveRequest
        >>> ali = Aligo()
        >>> share = ali.share_file('<file_id>')
        >>> # noinspection PyShadowingNames
        >>> share_token = ali.get_share_token(share.share_id)
