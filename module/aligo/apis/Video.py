...
from module.aligo.request import GetVideoPlayInfoRequest, GetVideoPreviewPlayInfoRequest
from module.aligo.response import GetVideoPlayInfoResponse, GetVideoPreviewPlayInfoResponse
from module.aligo.types.Enum import VideoTemplateID
