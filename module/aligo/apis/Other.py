...
from module.aligo.core.Config import V2_FILE_GET_OFFICE_PREVIEW_URL
from module.aligo.request import GetFilePathRequest
from module.aligo.response import GetFilePathResponse, GetOfficePreviewUrlResponse
...
class Other(Core):
    ...
    def get_path(self, file_id: str, drive_id: str = None) -> GetFilePathResponse:
        ...
        用法示例：
        >>> from module.aligo import Aligo, BaseFile, GetFilePathResponse
        >>> aligo = Aligo()
