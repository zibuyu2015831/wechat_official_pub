...
from module.aligo.request import SearchFileRequest, AimSearchRequest
from module.aligo.types import BaseFile
from module.aligo.types.Enum import SearchCategory, BaseFileCategory
...
class Search(Core):
    ...
    def search_files(self, body: SearchFileRequest) -> List[BaseFile]:
        ...
        用法示例：
        >>> from module.aligo import Aligo, SearchFileRequest
        >>> ali = Aligo()
    ...
    def search_aims(self, body: AimSearchRequest) -> List[BaseFile]:
        ...
        用法示例：
        >>> from module.aligo import Aligo, AimSearchRequest
        >>> ali = Aligo()
