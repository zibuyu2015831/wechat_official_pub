...
from module.aligo.core.Config import ADRIVE_V1_FILE_GET_FOLDER_SIZE_INFO
from module.aligo.request import GetFileRequest, GetFileListRequest, BatchGetFileRequest, CreateFolderRequest
...
class File(Core):
    ...
    def get_file(self, file_id: str, drive_id: str = None) -> BaseFile:
        ...
        用法示例:
        >>> from module.aligo import Aligo, BaseFile
        >>> ali = Aligo()
    ...
    def get_file(self, body: GetFileRequest) -> BaseFile:
        ...
        用法示例:
        >>> from module.aligo import Aligo, BaseFile, GetFileRequest
        >>> ali = Aligo()
    ...
    def get_file_list(self, body: GetFileListRequest) -> List[BaseFile]:
        ...
        用法示例:
        >>> from module.aligo import Aligo, BaseFile, GetFileListRequest
        >>> ali = Aligo()
    ...
    def batch_get_files(self, file_id_list: List[str], drive_id: str = None) -> List[BatchSubResponse]:
        ...
        用法示例:
        >>> from module.aligo import Aligo, Null
        >>> ali = Aligo()
