...
from module.aligo.core.Config import (ADRIVE_V1_ALBUM_GET, ADRIVE_V1_ALBUM_CREATE, ADRIVE_V1_ALBUM_DELETE,
                               ADRIVE_V1_ALBUM_ADD_FILES, ADRIVE_V1_ALBUM_UPDATE)
from module.aligo.request import AlbumListRequest, AlbumListFilesRequest
from module.aligo.types import ListAlbumItem, BaseAlbum, BaseFile
from module.aligo.types.Enum import GetShareLinkListOrderBy, OrderDirection
