...
from module.aligo.core import Auth
from module.aligo.core.Config import API_HOST, V2_FILE_GET, V2_DATABOX_GET_PERSONAL_INFO, V3_BATCH
from module.aligo.request import GetFileRequest, BatchRequest
from module.aligo.response import GetPersonalInfoResponse, BatchSubResponse
from module.aligo.types import DatClass, DataType, Null, EMailConfig, BaseUser, BaseDrive, BaseFile
...
class BaseAligo:
    ...
    def __init__(
        ...
        self.get_file_response = Response()
        self.get_file_list_response = Response()
