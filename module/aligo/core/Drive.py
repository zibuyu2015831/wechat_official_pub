...
from module.aligo.core.Config import (V2_DRIVE_GET, V2_DRIVE_GET_DEFAULT_DRIVE, V2_DRIVE_LIST_MY_DRIVES,
                               ADRIVE_V1_USER_GET_USER_CAPACITY_INFO)
from module.aligo.request import GetDriveRequest, GetDefaultDriveRequest
from module.aligo.response import ListMyDrivesResponse
from module.aligo.types import BaseDrive
